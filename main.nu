        ...
        "project" => {
            ...
            match $rest.1 {
                "onboard" => {
                    ...
                    let ado_pat             = (get-flag $rest "--ado-pat"             | default "")
                    let dry_run             = ("--dry-run" in $rest)
                    onboard-project --project-name $project_name --subscription-id $subscription_id --tenant-id $tenant_id --ado-org $ado_org --backstage-object-id $backstage_object_id --subscription-name $subscription_name --group-object-id $group_object_id --ado-pat $ado_pat --dry-run=$dry_run
                },
                _ => {
